...
def iptarget_results(iptarget):
    server = requests.post("www.ip-tracker.org/locator/ip-lookup.php?ip=%s --user-agent Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.31 (KHTML, like Gecko) Chrome/26.0.1410.63 Safari/537.31" %iptarget)
    print (server.text)
